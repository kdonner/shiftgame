...
public enum Dimensions {
	...
	DIM1 ((Constants.GRAVITY / Shift.FRAME_RATE), true, 20, 1, new float[]{0.9f, 0.9f, 0.9f, 1f}), //White
	DIM2 ((Constants.GRAVITY / Shift.FRAME_RATE) / 4, true, 20, 2, new float[]{0f, 0.1f, 1f, 1f}), //Blue
	DIM3 ((Constants.GRAVITY / Shift.FRAME_RATE) * 4, true, 20, 3, new float[]{1f, 0.05f, 0f, 1f}), //Red
	DIM4 ((Constants.GRAVITY / Shift.FRAME_RATE), false, -20, 4, new float[]{0.33f, 0.0f, 0.5f, 1f}), //Indigo
