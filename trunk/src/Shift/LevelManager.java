...
public class LevelManager implements java.io.Serializable
{
	...
	private void mapLevel2() throws NameTakenException
	{
		...
		addLevel("2.4", Constants.LEVEL_DIR + "level2.4");
		addLevel("2.5", Constants.LEVEL_DIR + "level2.5");
		addLevel("2.6", Constants.LEVEL_DIR + "level2.6");
	}
	...
	private void mapLevel3() throws NameTakenException
	{
		...
		addLevel("3.3", Constants.LEVEL_DIR + "level3.3");
		addLevel("3.4", Constants.LEVEL_DIR + "level3.4");
		addLevel("3.5", Constants.LEVEL_DIR + "level3.5");
	}
